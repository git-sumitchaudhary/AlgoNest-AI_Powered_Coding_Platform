...
import FloatingLabelInput from '../component/forms/FloatingLabelInput';
import TagInput from '../component/forms/tagsInput';
...
const AskQuestionPage = () => {
  ...
  const onSubmit = async (data) => {
    ...
    const promise = axios_client.post('/discussion/create', { ...data, tags });
