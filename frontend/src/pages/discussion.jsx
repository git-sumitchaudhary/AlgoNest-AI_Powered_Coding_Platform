...
import DiscussionCard from '../component/discussions/DiscussionCard'; // Corrected path
import StyledButton from '../components/ui/StyledButton';
import FilterChips from '../component/discussions/FilterChips'; // Corrected path
...
const ForumPage = () => {
  ...
  useEffect(() => {
    const fetchQuestions = async () => {
      try {
        setLoading(true);
        const response = await axios_client.get('/discussion/getAllQuestions');
